        ...
        <div className="mb-12">
          ...
          {!playersLoading && !playersError && (!players || players.length === 0) && (
            <EmptyState 
              ...
              description={isConfigured ? "Player rankings will appear here once available." : "Connect the Cricket API to view player rankings."}
            />
          )}
        ...
        <div>
          ...
          {!teamsLoading && !teamsError && (!teams || teams.length === 0) && (
            <EmptyState 
              ...
              description={isConfigured ? "Team rankings will appear here once available." : "Connect the Cricket API to view team rankings."}
            />
          )}
