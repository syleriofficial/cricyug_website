            ...
            <div className="mb-6 flex items-center gap-3 rounded-lg bg-primary/10 border border-primary/20 px-4 py-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Add CRICKET_API_KEY environment variable to display live match data.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="lg:col-span-3">
            ...
            {!isLoading && !error && (!filteredMatches || filteredMatches.length === 0) && (
              <EmptyState 
                ...
                description={isConfigured ? "Match data will appear here once available." : "Connect the Cricket API to view live and upcoming matches."}
              />
            )}
